...
import PrizesComponent from '../../hackathons/components/PrizesComponent';
import Oppertunity from '../../hackathons/components/Oppertunity';
          ...
          <div className=' mx-5 mt-5 flex flex-row space-x-2'>
            <div className='w-2/3'>
              <div className='border w-full rounded-md bg-white p-3'>
                <div className='w-full flex flex-row'>
                    ...
                    <div className='flex flex-col ml-4 text-md '>
                      <div className='text-3xl font-medium'>Konark TechFest</div>
                      <div className='text-md'><a>Tech Week 2024</a></div>
                      <div className=''><a href="" className='text-sm font-blue-500'>Guru jambheshwar University, HISAR</a></div>
                    </div>
                </div>
                <div className='mt-3'>
                    <Tags tagList={["#TechFest", "#Gju", "#Brain Storming", "#Guru Jambheshwar University"]}/>
                </div>
              </div>
              ...
              <div className='border rounded-md px-2 py-2 my-3'>
                  <div className='mt-3'>
                    <p className='text-2xl px-2 font-semibold text-gray-700'>Fest Rounds</p>
                  </div>
                  <FestRounds roundDetails='Students need to fein out the Clue from the image and top 5 winners will get the Prizes' 
                              roundName='Brain Storming' startDate='22/04/2024' endDate='22/05/2024'/>
                  <FestRounds roundDetails='Students need to solve 5 problems of Dsa within a time limit of the 1 hour and top Participants will get the Prize of approx 20,000' 
                ...
                <div className='mt-3 border rounded-md py-3 px-5'>
                  ...
                  <div>
                    <ul className='flex justify-between mt-2 text-sm'>
                      <li>Nit College Students</li>
                      <li>Final An Prefinal Year Students</li>
                    </ul>
                  </div>
                </div>
