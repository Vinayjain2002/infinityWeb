  ...
  return (
    ...
    <div className='w-full'>
      <div className='flex flex-row justify-between items-center'>
        ...
        <div className='flex md:ml-0 ml-auto  flex-row items-center space-x-3 justify-center'>
            ...
            <div className='flex flex-row border bg-white border-gray-400 py-2 space-x-4 px-3 rounded-sm'>
               {
                 props.buttons.map((button) => (
                  <button key={button.text} className='text-blue-400  focus:underline focus:decoration-1 focus:text-blue-700 md:text-md text-sm' onClick={() => button.handleClick()}>
                    {button.text}
                  </button>
                ))
               }
