   ...
   <div>
    {
      hackathons.map((hackathon)=>(
        <div className='my-5 w-full md:mr-5 bg-white'>
        <div className='p-5 flex border'>
          <div className='lg:w-1/3 w-1/3 md:w-2/5 bg-black'><img></img></div>
          <div className='flex flex-col ml-5'>
          <div className=''>
            <p className='lg:text-md md:text-md'>Google Ai Hackathons</p>
          </div>
          <div className='flex mt-4 space-between gap-4'>
            <button className='text-sm rounded-md bg-blue-500 px-2'>20 days left</button>
