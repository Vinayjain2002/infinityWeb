...
export const DetailedFestSidebar: React.FC<SideBarProps> = ({
  entryFee,
  registerationUrl,
  level,
  prizes,
      ...
      <div className="w-full  bg-white border rounded-md">
        <div className="flex mx-5 py-2 justify-between">
          <div className="text- lg:text-lg py-2 font-bold">
            Entry Fees: <span className="font-normal pl-2">${entryFee}</span>
          </div>
        ...
        <div className="bg-blue-50 ">
          <div className=" rounded-md  flex-col bg-white space-y-3 py-2 flex justify-between pl-0  flex-wrap">
            <EventWidget imageUrl="" heading="level" value={level} />
            <EventWidget imageUrl="" heading="prizes" value={prizes} />
            <EventWidget imageUrl="" heading="mode" value={mode} />
          </div>
        </div>
        <div className="my-2">
          {" "}
