        ...
        <div className="xl:w-1/2 lg:w-3/5 md:w-4/5 sm:w-3/5 w-4/5">
          ...
          <div>
            <button
              ...
              className="bg-transparent hover:bg-blue-500 text-blue-500 md:w-4/9 w-full  py-2 px-4 mt-2 border border-blue-500 hover:border-transparent rounded shadow opacity-75 hover:text-white"
            >
              Login With Google
            </button>
            <div className="flex">
