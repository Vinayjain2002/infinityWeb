        ...
        <div>
          <div className="flex flex-col md:flex-row justify-between w-full md:px-12 px-5 h-full space-x-5 mt-10">
            <div className="md:w-1/2 w-full text-2xl">
              ...
              <div className="md:w-full w-full md:h-[80vh] h-[70vh] overflow-y-scroll scrollbar snap-y ">
        ...
        <div className="bg-hover-blue mt-10 pt-10">
          <div className="flex flex-col md:px-12 px-5">
            <div className="flex-row flex justify-between">
              ...
              <div>
                <button
                  className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden font-medium  rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 focus:outline-none "
                  onClick={(e) => {
                    e.preventDefault();
                    navigate("/fest", {
                      state: {
                ...
                >
                  <span className="relative px-5 py-2 transition-all ease-in text-blue-700   text-xs md:text-md xl:text-lg font-semibold lg:font-normal duration-75 bg-white dark:bg-gray-900 hover:text-white dark:text-white   rounded-md group-hover:bg-opacity-0">
            ...
            <div className="flex flex-col md:flex-row justify-between w-full h-full space-x-5">
              <div className=" w-full h-[60vh] overflow-y-scroll scrollbar snap-y">
                <ul className=" w-full">
              ...
              <div className="w-full h-[60vh] hidden md:flex space-y-2  overflow-y-scroll scrollbar snap-y">
                <ul className=" w-full">
                  {festData.map((fest, index) => (
                    <a
                      href={`/fest/${encodeURIComponent(fest.id)}`}
          ...
          <div className="flex flex-col md:px-12 px-5">
            <div className="flex-row flex justify-between">
              ...
              <div>
                ...
                >
                  <span className="relative px-5 py-2 transition-all ease-in text-blue-700 z-1   text-xs md:text-md xl:text-lg font-semibold lg:font-normal duration-75 bg-white dark:bg-gray-900 hover:text-white dark:text-white   rounded-md group-hover:bg-opacity-0">
            ...
            <div className=" w-full mr-5 mt-2  mb-10 ">
              <div className="w-full flex md:flex-row space-x-2 flex-col">
                ...
                <div className="w-full h-[60vh] hidden md:flex  overflow-y-scroll scrollbar snap-y">
                  <ul className=" w-full space-y-2">
                    {bootcampData.map((bootcamp, index) => (
                      <a
