...
const Preferences: React.FC = () => {
  const handleSkillsChange = (skills: string[]) => console.log(skills);

  return (
    <div className="flex w-screen h-auto min-h-screen flex-col bg-dark-blue">
      <div className="w-full flex flex-column items-center justify-center mt-10">
        <h1 className="text-4xl text-white text-center font-bold">Events Preference</h1>
      </div>
      <div>
        <p className="mt-2 text-white text-center font-sm">
          It will help us to update about the different Events, Hackathons, Bootstrap
        </p>
      </div>
        ...
        <div className="mx-20 bg-white rounded-md">
          <form action="" onSubmit={(e) => e.preventDefault()} className="px-5 py-10">
            <div>
              ...
              <InputComponent />
              <LevelOptions />
              {/* we need to pass the option of the College Name in this input Field */}
              <InputComponent />
              <DateSelector />
