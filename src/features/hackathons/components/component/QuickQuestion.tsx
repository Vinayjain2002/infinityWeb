    ...
    <div className='bg-white  lg:mx-2.5 md:mx-6 sm:mx-2.5 mx-2 rounded-md'>
      <div className='w-full'>
       <div className=' py-5 px-3'>
                <div><p className='text-lg md:text-xl  xl:text-2xl text-dark-blue font-semibold'>Frequently Asked Questions</p></div>
                <ul className='lg:pl-5 pl-3 cursor-pointer'>
                  <li key="q1" onClick={()=>handleAnswertToggle("q1")} className='text-dark-blue lg:my-2 my-1 text-md'>What is a hackathon?
                  ...
                  <li key="q2" onClick={()=>handleAnswertToggle("q2")} className='text-dark-blue lg:my-2 my-1 text-md'>Do I need coding skills for the hackathon?
                  ...
                  <li key="q3" onClick={()=>handleAnswertToggle("q3")} className='text-dark-blue lg:my-2 my-1 text-md'>Can I go to a hackathon with no experience?
                  ...
                  <li key="q4" onClick={()=>handleAnswertToggle("q4")} className='text-dark-blue lg:my-2 my-1 text-md'>Do companies hire from hackathons?
